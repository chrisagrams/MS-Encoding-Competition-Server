              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      A short name for your submission.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
                    ...
                    <FormControl>
                      ...
                      >
                        ...
                        {isDragActive ? (
                          ...
                          <p>
                            Drag and drop ZIP file here, or click to select one
                          </p>
                        )}
                      </div>
                    </FormControl>
                    <FormDescription>
                      Upload your file. Must be a ZIP and less than 25MB.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
